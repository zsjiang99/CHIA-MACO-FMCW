...
function App(){
 ...
 return <main className="cgra-web"><header className="app-bar"><div><strong>RACO</strong><span>Agentic CGRA hardware/software co-design for FMCW radar with CHIA</span></div><nav aria-label="Experiment mode"><a className={demo?'active':''} href="/?demo=1">Earlier demo</a><a className={!demo?'active':''} href="/?mode=live">Live exploration</a></nav></header>
