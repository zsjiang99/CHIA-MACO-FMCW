...
function App(){
 ...
 return <main className="cgra-web"><header className="app-bar"><strong>RACO</strong><nav aria-label="Experiment mode"><a className={demo?'active':''} href="/?demo=1">Earlier demo</a><a className={!demo?'active':''} href="/?mode=live">Live exploration</a></nav></header>
